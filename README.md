...
Reconfigured the DHCP server to the Pi hole, allowing automatic DNS resolution, blocklisting ads and malicious domains, and allowing automatic configuration on each device connected to the wifi.
